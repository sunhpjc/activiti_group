...
import com.sujian.blindbox.dao.UserDao;
...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public ResultVO<User> queryById(Integer id) {
        User user = userDao.queryById(id);
        return ResultVO.getSuccessBody(ResponseCodeEnum.SUCCESS, user);
    }
